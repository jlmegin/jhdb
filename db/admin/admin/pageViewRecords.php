				...
				<table class="table">
					...
					<tr>
						<td align="center">
							Show records from
							<?php
								$arrFields=array('', 'tblContributors', 'tblEntities', 'tblGalleries', 'tblAccessions', 'tblGalleryItems', 'tblContentTypes', 'tblSubGalleryTypes', 'tblSources', 'tblTemplates', 'tblNavMenu', 'tblUploadLogs', 'tblSidebarEntries', 'tblKeywords');
								$arrFieldCaptions=array('All tables', 'tblContributors', 'tblEntities', 'tblGalleries', 'tblAccessions', 'tblGalleryItems', 'tblContentTypes', 'tblSubGalleryTypes', 'tblSources', 'tblTemplates', 'tblNavMenu', 'tblUploadLogs', 'tblSidebarEntries', 'tblKeywords');
