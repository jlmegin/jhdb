...
<?php $current_table = 'tblContributors'; ?>
<script>
			...
			<table class="table table-striped table-hover table-condensed">
				...
				<tbody>
					...
					<tr>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][3]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][3]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="mailto:<?php echo $record[3]; ?>" class="btn btn-info" title="<?php echo html_attr($record[3]); ?>"><i class="glyphicon glyphicon-envelope"></i></a></td>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][12]}"; ?> text-right" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][12]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><?php echo $record[12]; ?></td>
					</tr>
					<?php } ?>
				</tbody>
				<tfoot>
