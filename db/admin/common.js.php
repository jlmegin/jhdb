...
function tblContributors_validateData(){
	return true;
}
function tblEntities_validateData(){
	return true;
}
function tblGalleries_validateData(){
	return true;
}
function tblAccessions_validateData(){
	return true;
}
function tblGalleryItems_validateData(){
	return true;
}
function tblContentTypes_validateData(){
	return true;
}
function tblSubGalleryTypes_validateData(){
	return true;
}
function tblSources_validateData(){
	return true;
}
function tblTemplates_validateData(){
	return true;
}
function tblNavMenu_validateData(){
	return true;
}
function tblUploadLogs_validateData(){
	return true;
}
function tblSidebarEntries_validateData(){
	return true;
}
function tblKeywords_validateData(){
	return true;
}
